...
//		String deviceName1 = "Baxter.FileBackupConfigurator";
	...
	//task 198 : Update Correct Treatment File without Backup
			...
			public void Update_Correct_Treatment_File_without_Backup() {
				// BEFORE EXECUTE: Make sure there is no content in Treatment file in the Baxter.ClariaFileRepository
				//If already have treatment file in Backup or main, delete it at the beginning
				TWXServices.DeleteFile("441/177/441177/TreatmentResults/Backup/"+FileName1);
				TWXServices.DeleteFile("441/177/441177/TreatmentResults/"+FileName1);
				// Start task:
				Long initialTime = (Long) new Date().getTime();
				Integer serialNumber = 441177;
//				String deviceName = "Claria.".concat(serialNumber.toString());
//				String deviceName1 = "Baxter.FileBackupConfigurator";
				...
				Assert.assertEquals(0,TWXServices.getTreatmentFileFileCombination_TreatmentFile(deviceName));//  valid path: Thing: Baxter.ClariaFileRepository/GetFileListingWithLinks, input =  /441/188/441188/SettingsResponse/Backup/
