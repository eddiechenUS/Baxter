...
//		TWXServices.getDataTableColumnDataByTimeDescend("Baxter.UploadFailureDataTable","deviceName" );
//		TWXServices.getDataTableColumnDataByTimeDescend("Baxter.UploadFailureDataTable","timestamp" );
//		TWXServices.getDataTableColumnDataByTimeDescend("Baxter.UploadFailureDataTable","attempt" );
//		TWXServices.getDataTableColumnDataByTimeDescend("Baxter.UploadFailureDataTable","path" );
//		String path=TWXServices.returnClariaDeviceFilePath(deviceName);
//		TWXServices.DeleteFolder(path+"SettingsRequest/");
//		String CorrectTreatmentFilePath = "441/177/441177/TreatmentResults/T_C_2_1501001701_00001.tar.gz.enc";
		TWXServices.ClearFileManualUploadAddOrUpdateTreatmentFileToRetryDataTable_Combination(deviceName, error_treatment_file_BLOBString,error_treatment_file_name);
...
//		TWXServices.ManualUploadTreatmentFileToRepo(error_treatment_file_path,error_treatment_file_BLOBString);
		TWXServices.AddOrUpdateRetryDataTableEntries("Claria.441177", "441/177/441177/TreatmentResults/T_2019-08-21-15-34-48_C_2_1501001701_00001.tar.gz.enc");
	*/	
		
//		RestAssured.useRelaxedHTTPSValidation();
//		System.out.println(TWXServices.getBaxterFileBackupConfigurator_IsFileBackupEnabled("ClariaTreatmentFileBackup"));
